...
static const CGFloat kAlertTitleLabelFontSize = 16;
static const CGFloat kAlertDescriptionLabelFontSize = 14;
static const CGFloat kAlertButtonFontSize = 14;

static NSString* kAlertOKButtonNormalColor = @"#e51c23";
static NSString* kAlertOKButtonHighlightColor = @"#b0120a";

static NSString* kAlertCancelButtonNormalColor = @"#5677fc";//blue
static NSString* kAlertCancelButtonHighlightColor = @"#2a36b1";
...
{
    NSLog(@"kAlertButtonSideMargin: %f, kAlertDescriptionLabelHeight: %f",kAlertButtonSideMargin,kAlertDescriptionLabelHeight);
    NSLog(@"kAlertTitleLabelTopMargin: %f, kALertDescriptionLabelTopMargin: %f",kAlertTitleLabelTopMargin,kALertDescriptionLabelTopMargin);
